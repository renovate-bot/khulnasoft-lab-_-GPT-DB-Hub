...
train_log="gptdb_hub/output/logs/train_sft_test_${current_date}.log"
start_time=$(date +%s)
...
#     --deepspeed gptdb_hub/configs/stage2.json \
#     --quantization_bit 4 \
...
#     --lora_alpha 32 \
#     --lora_target q_proj,v_proj \
#     --output_dir gptdb_hub/output/adapter/llama2-13b-qlora_1024_epoch1_debug1008_withDeepseed_mulitCard \
#     --overwrite_cache \
#     --overwrite_output_dir \
#     --per_device_train_batch_size 1 \
#     --gradient_accumulation_steps 16 \
...
# 多卡，deepseed，全量微调
# deepspeed --include localhost:4,5,6,7  gptdb_hub/train/sft_train.py \
#     --dataset example_text2sql_train \
...
#     --max_target_length 512 \
#     --template llama2 \
#     --output_dir gptdb_hub/output/adapter/code-llama-7b-2048_epoch4_full \
#     --overwrite_cache \
#     --overwrite_output_dir \
...
#     --plot_loss \
#     --bf16 True\
#     --deepspeed gptdb_hub/configs/stage3.json 2>&1 | tee ${train_log}
