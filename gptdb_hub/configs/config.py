...
ADAPTER_PATH = os.path.join(ROOT_PATH, "gptdb_hub/output/adapter")
MERGED_MODELS = os.path.join(ROOT_PATH, "gptdb_hub/output/merged_models")

# DATA_PATH = "/root/autodl-tmp/data/spider/pre_processed_data"
# OUT_DIR= "/root/autodl-tmp/codellama"

DATA_PATH = os.path.join(ROOT_PATH, "gptdb_hub/data")
PREDICTED_DATA_PATH = os.path.join(ROOT_PATH, "gptdb_hub/data/eval_data/dev_sql.json")
PREDICTED_OUT_FILENAME = "pred_sql.sql"
# OUT_DIR = os.path.join(DATA_PATH, "out_pred")
OUT_DIR = os.path.join(ROOT_PATH, "gptdb_hub/output/")
