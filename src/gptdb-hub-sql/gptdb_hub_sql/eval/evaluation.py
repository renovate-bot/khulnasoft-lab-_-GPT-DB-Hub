...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="./gptdb_hub_sql/data/spider/database",
    )
    parser.add_argument(
        "--table",
        dest="table",
    ...
    if args.natsql:
        ...
        args.gold = "./gptdb_hub_sql/data/eval_data/gold_natsql2sql.txt"
        args.table = "./gptdb_hub_sql/data/eval_data/tables_for_natsql2sql.json"
    else:
        output_file_path = args.input
        # args.gold = "./eval/data/gold.txt"
        args.gold = "./gptdb_hub_sql/data/eval_data/gold.txt"
        args.table = "./gptdb_hub_sql/data/eval_data/tables.json"
