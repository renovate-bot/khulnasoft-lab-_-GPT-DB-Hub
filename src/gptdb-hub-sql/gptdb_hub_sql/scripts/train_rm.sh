...
deepspeed --num_gpus 4  gptdb_hub_sql/train/rm_train.py \
    --deepspeed gptdb_hub_sql/configs/ds_config.json \
    --stage rm \
    ...
    --lora_rank 64 \
    --lora_alpha 32 \
    --output_dir gptdb_hub_sql/output/adapter/qwen-7b-rm-test \
    --overwrite_cache \
